...
#define STRING_CONFIG_H_AUTHOR "(Johan Nordberg, FLSUN Q5)" // Who made the changes.
...
#define MACHINE_UUID "F9A1996B-C3E8-42F4-AC63-0BCA0B356FAD"
...
#define DELTA
  ...
  #define DELTA_PRINTABLE_RADIUS 105.00    // (mm)
  ...
  // see https://www.thingiverse.com/thing:1274733
  //#define DELTA_DIAGONAL_ROD_TRIM_TOWER { 0.000, 0.000, 0.000 }
#endif
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -3.0, -1.3, -20.1 }
